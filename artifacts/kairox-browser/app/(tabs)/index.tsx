  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.routeLine}><StatusPill label={`Privacy: ${settings.privacyMode}`} tone="good" /><StatusPill label={`Route: ${settings.routeMode === 'direct' ? 'Direct' : 'User route'}`} /><StatusPill label={Platform.OS === 'web' ? 'Engine: Web preview' : 'Engine: Kairox WebView'} /></View>
