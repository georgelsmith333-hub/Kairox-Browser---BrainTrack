# Migrating web UI to Kairox Design System

Read `artifacts/kairox-design-system/docs/AGENTS.md` and
`artifacts/kairox-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/kairox-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/kairox-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/kairox-design-system/hooks/use-toast`
