# Consuming Kairox Design System in web apps

Read `artifacts/kairox-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/kairox-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/kairox-design-system/styles.css";
```
...
`node_modules/@workspace/kairox-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/kairox-design-system/components/ui/button";
import { cn } from "@workspace/kairox-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/kairox-design-system/hooks/use-toast";
```
...
`@workspace/kairox-design-system/components/ui/button`. Run the app's typecheck
