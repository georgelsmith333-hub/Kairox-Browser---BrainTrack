# Kairox Design System design system
...
workspace package (`@workspace/kairox-design-system`): other artifacts depend
...
`@workspace/kairox-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/kairox-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/kairox-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/kairox-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/kairox-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/kairox-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/kairox-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/kairox-design-system/docs/migrating-expo.md`
