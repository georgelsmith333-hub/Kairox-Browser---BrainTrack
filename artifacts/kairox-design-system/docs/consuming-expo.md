# Consuming Kairox Design System in Expo apps

Read `artifacts/kairox-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/kairox-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/kairox-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/kairox-design-system/lib/native-theme";
...
```tsx
import { Badge } from "@workspace/kairox-design-system/components/native/badge";
import { Button } from "@workspace/kairox-design-system/components/native/button";
import { Card } from "@workspace/kairox-design-system/components/native/card";
```
...
Import and render
`@workspace/kairox-design-system/components/native/button`, then run Expo
