# Migrating Expo UI to Kairox Design System

Read `artifacts/kairox-design-system/docs/AGENTS.md` and
`artifacts/kairox-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/kairox-design-system/lib/native-theme` and
  `@workspace/kairox-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/kairox-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/kairox-design-system` and retains only
